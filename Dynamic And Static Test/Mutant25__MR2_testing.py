...
class TestMutation25MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation25_mr2_deletion(self):
        print("\n--- Testing MR2 for Mutation 25: Deletion with Tree Properties Verification ---")
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation25MR2))
