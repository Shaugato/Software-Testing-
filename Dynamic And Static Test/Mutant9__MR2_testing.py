...
class TestMutation9MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation9_mr2_search_deletion(self):
        print("\n--- Testing MR2 for Mutation 9: Search and Deletion with Incorrect Traversal ---")
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation9MR2))
