...
class TestMutation27MR1(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation27_mr1_insertion(self):
        print("\n--- Testing MR1 for Mutation 27: Insertion with Tree Properties ---")
...
# Running MR1 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation27MR1))
