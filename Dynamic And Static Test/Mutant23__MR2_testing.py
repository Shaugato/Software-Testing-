...
class TestMutation23MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation23_mr2_deletion(self):
        print("\n--- Testing MR2 for Mutation 23: Deletion with Pre-Order Traversal Verification ---")
        ...
        expected_pre_order = [50, 40, 10, 70, 60, 80]
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation23MR2))
