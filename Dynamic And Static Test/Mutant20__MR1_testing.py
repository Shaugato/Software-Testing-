...
class TestMutation20MR1(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation20_mr1_insertion(self):
        print("\n--- Testing MR1 for Mutation 20: Insertion with Pre-Order Traversal Verification ---")
        ...
        # Expected pre-order traversal should be the insertion order but with the correct tree structure
...
# Running MR1 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation20MR1))
