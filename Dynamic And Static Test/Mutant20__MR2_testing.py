...
class TestMutation20MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation20_mr2_deletion(self):
        print("\n--- Testing MR2 for Mutation 20: Deletion with Pre-Order Traversal Verification ---")
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation20MR2))
