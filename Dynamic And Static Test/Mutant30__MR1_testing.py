...
class TestMutation30MR1(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation30_mr1_insertion(self):
        print("\n--- Testing MR1 for Mutation 30: Insertion with Tree Properties ---")
...
# Running MR1 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation30MR1))
