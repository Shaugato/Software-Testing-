...
class TestMutation21MR1(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation21_mr1_insertion(self):
        print("\n--- Testing MR1 for Mutation 21: Insertion with Pre-Order Traversal Verification ---")
        ...
        # Expected pre-order traversal should be in the correct order for pre-order
...
# Running MR1 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation21MR1))
