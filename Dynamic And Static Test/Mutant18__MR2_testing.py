...
class TestMutation18MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation18_mr2_deletion(self):
        print("\n--- Testing MR2 for Mutation 18: Deletion with Min Label Verification ---")
        ...
        # Expected min label should be 30, but due to the mutation, it will return 42
        try:
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation18MR2))
