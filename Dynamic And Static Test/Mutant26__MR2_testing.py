...
class TestMutation26MR2(unittest.TestCase):
    def setUp(self):
        self.bst = BinarySearchTree()

    def test_mutation26_mr2_deletion(self):
        print("\n--- Testing MR2 for Mutation 26: Deletion with Tree Properties Verification ---")
...
# Running MR2 Test
unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromTestCase(TestMutation26MR2))
